...
const Login = ({ mode }) => {
  ...
  const lightIllustration = '/images/illustrations/auth/login.png'
  const borderedDarkIllustration = '/images/illustrations/auth/login.png'
  const borderedLightIllustration = '/images/illustrations/auth/login.png'
      ...
      <div className='flex justify-center items-center bs-full bg-backgroundPaper !min-is-full p-6 md:!min-is-[unset] md:p-12 md:is-[480px]'>
        ...
        <div className='flex flex-col gap-6 is-full sm:is-auto md:is-full sm:max-is-[400px] md:max-is-[unset] mbs-8 sm:mbs-11 md:mbs-0'>
          <div className='flex flex-col gap-1'>
            <Typography variant='h4'>{`${themeConfig.templateName} Tedarikçi Portalına Hoş Geldiniz 👋🏻`}</Typography>
          ...
          <form noValidate autoComplete='off' onSubmit={handleSubmit(onSubmit)} className='flex flex-col gap-6'>
            ...
            <div className='flex justify-between items-center gap-x-3 gap-y-1 flex-wrap'>
              ...
              <Typography
                className='text-end text-estheticAll_orange'
                component={Link}
            ...
            <Button className=' text-white' fullWidth variant='contained' type='submit'>
              Giriş
            </Button>
