          ...
          <Grid container spacing={6}>
            <Grid item xs={12}>
              <div className='flex flex-row gap-4'>
                <img height={38} width={38} className='rounded' src={'/images/avatars/1.png'} alt='Profile' />
                <div>
                  <Typography variant='body1' className='font-medium'>
                    Alından Temassız Ateş Ölçer
                  </Typography>
                  <Typography variant='body1' className='font-medium text-estheticAll_orange'>
                    Ürün Kodu: #91716
                  </Typography>
                </div>
              </div>
